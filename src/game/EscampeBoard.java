...
>>>>>>> parent of ef70786... First win of IA :pray:
	...
	*/
	public boolean isValidMove(String move, String player) {
		if(move.contains("/") && move.length() == 17) {
			...
			//si joueur noir n'a pas jou� et que le joueur blanc veut jouer ==> false
			// ou si joueur blanc a d�j� jou� son coup
			...
			//check ligne
			if(player.equals("blanc")) { // si on arrive ici le premier coup a �t� jou�
				for (String mv : moveSquares) {
			...
			if(this.lastLisere == -1) {
				...
				//si la case de d�part est bien sur un lisere identique au dernier coup
			...
			//Test si pi�ce alli�e sur la case de d�part
			...
			//Test si pas de pi�ce ennemie sur la case d'arriv�e sauf si licorne 
	...
	private ArrayList<String> movesForSquare(int ligne, int col, int level, String initSquare, String player, ArrayList<String> previous) {
		...
		//Si d�j� visit� alors retourner array vide
	...
	*/
	public String[] possiblesMoves(String player) {		
		...
		for (int i = 0; i < board.length; i++) {
			Square[] squares = board[i];
			for (int j = 0; j < squares.length; j++) {
				if(( (squares[j].type().equals("B") | squares[j].type().equals("b")) && player.equals("blanc") ) || ( (squares[j].type().equals("N") | squares[j].type().equals("n")) && player.equals("noir") ) ) { //pion qui peut etre d�plac�
	...
	*/
	...
	public static void main(String[] args) {
		...
		e.play("A1-A2", "blanc");
		System.out.println("\n-------- Coup jou� A1-A2 par le joueur blanc --------");
		System.out.println(e);
<<<<<<< HEAD
=======
		*/
		...
		System.out.println("\n-------- Coup jou� C2-B4 par le joueur blanc --------");
		e.play("C2-B4", "blanc");
		for (int lis : e.getLiseresBlanc()) {
			System.out.println("LIS Blanc ==> " + lis);
		}
		...
		System.out.println("\n-------- Coup jou� A5-B5 par le joueur noir --------");
		e.play("A5-B5", "noir");
		for (int lis : e.getLiseresNoir()) {
			System.out.println("LIS Noir  ==> " + lis);
		}
